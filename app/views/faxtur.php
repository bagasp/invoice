...
<head>
	...
	<link href="<?= base_url() ?>ass/inv/css/style.css" rel="stylesheet">
	<link href="<?= base_url() ?>ass/inv/css/print.css" media="print">
	<script src="<?= base_url() ?>ass/inv/js/jquery-1.3.2.min.js"></script>
	<script src="<?= base_url() ?>ass/inv/js/example.js"></script>
