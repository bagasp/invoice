...
<body>
    ...
    <div class="container">
        ...
        <button align="right" class="btn btn-successs" onclick="add_barang()"><i class="glyphicon glyphicon-plus"></i> Add barang</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3" for="cari">Kode Item</label>
                            <div class="form-group">
                            <input type="text" class="form-control" id="kode_item" name="kode_item" value="BR<?php echo sprintf("%04s", $kode_item) ?>" readonly>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="namaitem" placeholder="Nama Item" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                            <input name="uom" placeholder="Uom" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="hargajual" placeholder="Harga jual" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
