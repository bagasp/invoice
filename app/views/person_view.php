...
<body>
    ...
    <div class="container">
        ...
        <button class="btn btn-successs" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Person</button>
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="namauser"]').val(data.namauser);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="namauser" placeholder="Nama User" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
